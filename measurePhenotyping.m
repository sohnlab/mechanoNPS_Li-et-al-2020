...
for i=1:size(MeasureOut,2)
    ...
    Phenotyping(:,i)=[MeasureOut(1,i); d; 700/dT; dTc; dD; Tr]; %file #, cell diameter[um], velocity at pore[mm/s], transit time at cont. channel[ms], deformed diameter[um], recovery time [ms]
end
